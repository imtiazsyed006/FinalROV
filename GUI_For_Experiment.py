...
import Gyro5 as gyro2
import HMC5883L as hmcl
import MS5803_05BA as depth
...
pi.set_servo_pulsewidth(ESC_GPIO1, 2000) # Maximum throttle.

pi.set_servo_pulsewidth(ESC_GPIO2, 2000) # Maximum throttle.

sleep(1)
pi.set_servo_pulsewidth(ESC_GPIO, 1000) # Minimum throttle.

pi.set_servo_pulsewidth(ESC_GPIO1, 1000) # Minimum throttle.

pi.set_servo_pulsewidth(ESC_GPIO2, 1000) # Minimum throttle.
...
"")
        ...
        self.checkBox_2.setGeometry(QtCore.QRect(350, 150, 70, 17))
        ...
        self.widget_8.setGeometry(QtCore.QRect(0, 300, 341, 150))
        ...
        self.checkBox_3.setGeometry(QtCore.QRect(20, 0, 70, 17))
        self.checkBox_3.setObjectName("checkBox_3")
        self.tabWidget.addTab(self.tab_3, "")
        self.tab_4 = QtWidgets.QWidget()
        self.tab_4.setObjectName("tab_4")
        self.widget_9 = PlotWidget(self.tab_4)
        self.widget_9.setGeometry(QtCore.QRect(1020, 0, 341, 150))
        self.widget_9.setObjectName("widget_9")
        self.widget_10 = PlotWidget(self.tab_4)
        self.widget_10.setGeometry(QtCore.QRect(0, 0, 341, 150))
        self.widget_10.setObjectName("widget_10")
        self.widget_12 = PlotWidget(self.tab_4)
        self.widget_12.setGeometry(QtCore.QRect(682, 0, 341, 150))
        self.widget_12.setObjectName("widget_12")
        self.widget_13 = PlotWidget(self.tab_4)
        self.widget_13.setGeometry(QtCore.QRect(341, 0, 341, 150))
        self.widget_13.setObjectName("widget_13")
        self.widget_14 = PlotWidget(self.tab_4)
        self.widget_14.setGeometry(QtCore.QRect(0, 150, 341, 150))
        self.widget_14.setObjectName("widget_14")
        self.widget_16 = PlotWidget(self.tab_4)
        self.widget_16.setGeometry(QtCore.QRect(340, 150, 341, 150))
        self.widget_16.setObjectName("widget_16")
        self.widget_15 = PlotWidget(self.tab_4)
        self.widget_15.setGeometry(QtCore.QRect(680, 150, 341, 150))
        self.widget_15.setObjectName("widget_15")
        self.widget_17 = PlotWidget(self.tab_4)
        self.widget_17.setGeometry(QtCore.QRect(1020, 150, 341, 150))
        self.widget_17.setObjectName("widget_17")
        self.widget_18 = PlotWidget(self.tab_4)
        self.widget_18.setGeometry(QtCore.QRect(0, 300, 341, 150))
        self.widget_18.setObjectName("widget_18")
        self.pushButton = QtWidgets.QPushButton(self.tab_4)
        self.pushButton.setGeometry(QtCore.QRect(460, 480, 75, 23))
        self.pushButton.setObjectName("pushButton")
        self.pushButton_7 = QtWidgets.QPushButton(self.tab_4)
        self.pushButton_7.setGeometry(QtCore.QRect(570, 480, 75, 23))
        self.pushButton_7.setObjectName("pushButton_7")
##################################################################################
        self.pushButton_7.clicked.connect(self.CAPTURE_2)
        self.pushButton.clicked.connect(self.CAPTURE_1)
##################################################################################      
        self.lineEdit = QtWidgets.QLineEdit(self.tab_4)
        self.lineEdit.setGeometry(QtCore.QRect(440, 360, 112, 20))
        ...
        self.lineEdit_3.setGeometry(QtCore.QRect(440, 440, 113, 20))
...
###################################################################################
        ...
        self.label_38.setGeometry(QtCore.QRect(600, 360, 71, 16))
        self.label_38.setObjectName("label_38")
        self.label_39 = QtWidgets.QLabel(self.tab_4)
        self.label_39.setGeometry(QtCore.QRect(600, 400, 71, 16))
        self.label_39.setObjectName("label_39")
        self.label_40 = QtWidgets.QLabel(self.tab_4)
        self.label_40.setGeometry(QtCore.QRect(600, 440, 71, 16))
        self.label_40.setObjectName("label_40")
        self.lcdNumber = QtWidgets.QLCDNumber(self.tab_4)
        self.lcdNumber.setGeometry(QtCore.QRect(1170, 340, 161, 41))
        self.lcdNumber.setObjectName("lcdNumber")
        self.label_41 = QtWidgets.QLabel(self.tab_4)
        self.label_41.setGeometry(QtCore.QRect(1020, 340, 141, 41))
        font = QtGui.QFont()
        ...
        self.pushButton_8.setGeometry(QtCore.QRect(490, 540, 131, 20))
        font = QtGui.QFont()
        font.setPointSize(11)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_4.setText(_translate("MainWindow", "Experiment Mode"))
        self.pushButton_5.setText(_translate("MainWindow", "Operation Mode"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), _translate("MainWindow", "Live Streaming"))
        self.pushButton.setText(_translate("MainWindow", "Start"))
        self.pushButton_7.setText(_translate("MainWindow", "Update"))
        self.label_38.setText(_translate("MainWindow", "Left Thruster"))
        self.label_39.setText(_translate("MainWindow", "Right Thruster"))
        self.label_40.setText(_translate("MainWindow", "Heave Thruster"))
        self.label_41.setText(_translate("MainWindow", "Pressure Value"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_4), _translate("MainWindow", "Experiment"))
...
###################Plots customization go here#########################
        self.widget_10.setTitle('Time vs Temperature')
        self.widget_13.setTitle('Time vs Pressure')
        self.widget_12.setTitle('Time vs Roll Angle')
        self.widget_9.setTitle('Time vs Pitch Angle')
        self.widget_14.setTitle('Time vs Ax')
        self.widget_16.setTitle('Time vs Ay')
        self.widget_15.setTitle('Time vs Az')
        self.widget_17.setTitle('Time vs Velocity')
        self.widget_18.setTitle('Time vs Depth')
        ...
        self.widget_13.setYRange(96000,110000)

        

#######################################################################
###################Plots go here#######################################
        self.plot_1 = self.widget_13.plot(self.t1,   self.pressure,pen=pen,fillLevel = 1,fillBrush = (255,255,255,50))
        self.plot_2 = self.widget_10.plot(self.t1,self.temperature,pen=pen,fillLevel = 1,fillBrush = (255,255,255,50))
        self.plot_3 = self.widget_12.plot(self.t,self.roll,pen=pen)
        self.plot_4 = self.widget_9.plot(self.t,self.pitch,pen=pen)
        self.plot_5 = self.widget_14.plot(self.t,self.xaccel,pen=pen)
        self.plot_6 = self.widget_16.plot(self.t,self.yaccel,pen=pen)
        self.plot_7 = self.widget_15.plot(self.t,self.zaccel,pen=pen)
#         self.plot_8 = self.widget_15.plot(self.t,self.Velocity,pen=pen)
        #self.plot_9 = self.widget_18.plot(self.t,self.Depth,pen=pen)
#         
        
        yticks = np.linspace(1,51,6)
        ticks = self.widget_10.getAxis('left')
...
# 
        ...
        self.timer_6.setInterval(10)
        self.timer_6.timeout.connect(self.SURGE)
        self.timer_6.start()
...
###################################################################################################
    ...
    def OPEN(self):
        ...
        self.plainTextEdit.clear()
        self.plainTextEdit.insertPlainText('You are operating ROV in Experimental Mode')
    ...
    def getValues(self):
        ...
        if self.Lstartbutton:
            if len(self.firstRun) <= self.DataPoints:
                ...
                xi,yi,zi,xii,yii = gyro2.GetGyroValues()
                xiii,yiii,ziii = compass.axes()
                #Deptha = depth.depthValue()
                #self.Depth.append(Deptha)
                self.roll.append(xii)
                self.pitch.append(yii)
                self.xaccel.append(xi)
                self.yaccel.append(yi)
                self.zaccel.append(zi)
            else:
                if not self.firstRun1:
                    ...
                    xi,yi,zi,xii,yii = gyro2.GetGyroValues()
                    xiii,yiii,ziii = compass.axes()
                    #Deptha = depth.depthValue()-self.meanDepth
                    self.roll = self.roll[1:]
                    self.pitch =self.pitch[1:]
                    self.xaccel = self.xaccel[1:]
                    self.yaccel = self.yaccel[1:]
                    self.zaccel = self.zaccel[1:]
                ...
                xiii,yiii,ziii = compass.axes()
                #Deptha = depth.depthValue()-self.meanDepth
                #rate = (Deptha-self.Depth[-1])/(time.time()-ptime)
                self.roll = self.roll[1:]
                self.pitch =self.pitch[1:]
                self.xaccel = self.xaccel[1:]
                self.yaccel = self.yaccel[1:]
    ...
    def getValues2(self):
        if self.Lstartbutton:
            if len(self.firstRun3) <= self.DataPoints:
                ...
                self.lcdNumber.display(pressure)
    ...
    def logData(self):
        if self.Lstartbutton:
            if not self.DLogButton:
                os.system('python3 /home/pi/Qt/FinalROV/Gyro4.py &')
                os.system('python3 /home/pi/Qt/FinalROV/MS5803_05BA_2.py &')
                ...
                os.system('sudo pkill -f Gyro4.py')
                os.system('sudo pkill -f MS5803_05BA_2.py')
    ...
    def UpdatePlot_1(self):
        if self.Lstartbutton:
            self.plot_2.setData(self.t1,self.temperature)
            self.plot_1.setData(self.t1,self.pressure)


    def UpdatePlot_2(self):
        if self.Lstartbutton:
            self.plot_3.setData(self.t,self.roll)
            self.plot_4.setData(self.t,self.pitch)
            #self.plot_8.setData(self.t,self.Velocity)
            #self.plot_9.setData(self.t,self.Depth)
            

    def UpdatePlot_3(self):
        if self.Lstartbutton:
            self.plot_5.setData(self.t,self.xaccel)
            self.plot_6.setData(self.t,self.yaccel)
            self.plot_7.setData(self.t,self.zaccel)
    ...
    def SURGE(self):
        if self.Lstartbutton and self.Start:
            pi.set_servo_pulsewidth(ESC_GPIO1, self.pwm_1[0])
            pi.set_servo_pulsewidth(ESC_GPIO,  self.pwm_2[0])
            pi.set_servo_pulsewidth(ESC_GPIO2, self.pwm_3[0])
            
        elif self.Lstartbutton and not self.Start:
    ...
    def CAPTURE_1(self):
        if not self.Start:
            self.pwm_1[0] = int(self.lineEdit.text())
            self.pwm_2[0] = int(self.lineEdit_2.text())
            self.pwm_3[0] = int(self.lineEdit_3.text())
            self.Start.append(1)
